...
back_choose = pygame.image.load("Lab8/image/back.png")
red_choose = pygame.image.load("Lab8/image/red.png")
blue_choose = pygame.image.load("Lab8/image/blue.png")
green_choose = pygame.image.load("Lab8/image/green.png")
white_choose = pygame.image.load("Lab8/image/white.png")
yellow_choose = pygame.image.load("Lab8/image/yellow.png")
rect_choose = pygame.image.load("Lab8/image/rect.png")
tria_choose = pygame.image.load("Lab8/image/tria.png")
circle_choose = pygame.image.load("Lab8/image/circle.png")
square_choose = pygame.image.load("Lab8/image/square.png")
eraser = pygame.image.load("Lab8/image/eraser.png")
    ...
    for event in pygame.event.get():
        ...
        if event.type == pygame.MOUSEBUTTONUP: 
            ...
            if x >= 20 and x <= 45 and y >= 20 and y <= 45: 
                ...
                pygame.draw.rect(screen, select, (randint(20, 580), randint(95, 600), 120, 75))
                ...
                pygame.draw.rect(screen, select, (randint(20, 580), randint(95, 600), 75, 75))
